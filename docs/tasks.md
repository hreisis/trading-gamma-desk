...
**Milestone 2 — Catalyst.** **M2-4B** deterministic market-reaction classification over M2-4A ETF moves. No LLM, causation claims, risk-on/off, hawkish/dovish, Market Temperature, or catalyst→regime linkage.
