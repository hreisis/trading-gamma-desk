...
| `studies/` | PIT research archive build/load/store + exact-date offline replay verification (M5-1B) | `DailyResearchArchive` from fixture/local manifest; atomic gitignored `data/studies/archive/`; no network / no latest-fallback |
