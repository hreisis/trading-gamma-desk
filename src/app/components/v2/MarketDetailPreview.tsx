  ...
  return (
    <section className="mk-card mk-structure">
      <div className="mk-section-head">
        ...
        <select value={symbol} readOnly aria-label={`${symbol} market structure`}><option>{symbol}</option></select>
      </div>
...
function RiskSnapshot({ view }: { view: V2CommandCenterPageView }) {
  ...
  return (
    <section className="mk-card mk-risk-snapshot">
      ...
      <div className="mk-snapshot-body">
        ...
        <small>High Beta: <em className={actionTone}>{action}</em>{highBeta == null ? "" : ` · Target ${highBeta}%`}</small>
      </div>
    </section>
  );
}
      ...
      <div className="mk-shell" id="top">
        ...
        <main className="mk-main">
          <div className="mk-center">
            ...
            <div id="structure"><MarketStructure view={view} symbol="SPY"/></div>
            <MarketStructure view={view} symbol="QQQ"/>
            <div className="mk-bottom-grid" id="rotation"><SectorRotation view={view}/><RiskSnapshot view={view}/></div>
