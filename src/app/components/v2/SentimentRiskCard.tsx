...
export function SentimentRiskCard({
  ...
  return (
    <a className="pv-sentiment-link" href={`/market?lang=${lang}`} aria-label={lang === "zh" ? "打开市场详情" : "Open market detail"}>
      <div className="pv-sentiment-head">
        <h3>SENTIMENT / RISK</h3>
        <span className="pv-market-detail-cue">{lang === "zh" ? "市场详情" : "MARKET DETAIL"} →</span>
      </div>
