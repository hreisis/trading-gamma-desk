...
export function MarketConsider({view, lang}: {view: V2CommandCenterPageView; lang: V2Language}) {
 ...
 return <section className={styles.consider} aria-labelledby="market-consider-title">
  ...
  <h1 id="market-consider-title">{title}</h1>
