...
const NO_EVENT_GATE_REASON =
  "Event/shock gate state builder is not implemented; catalyst calendar is tracked separately.";
...
export function buildMarketInputSnapshot(
  ...
  const inputs: MarketInputField[] = [
    ...
    missingField("event_gate", NO_EVENT_GATE_REASON),
